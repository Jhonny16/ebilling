...
class ImpuestoType(GeneratedsSuper):
    ...
    def __init__(self, Codigo=None, CodigoTarifaIVA=None, Tarifa=None, FactorIVA=None, Monto=None, Exoneracion=None,
                       indicator_prod_service=None, NoSujeto=None):
        self.original_tagname_ = None
        self.Codigo = Codigo
    ...
    def get_NoSujeto(self):
        return self.NoSujeto

    def set_NoSujeto(self, NoSujeto):
        self.NoSujeto = NoSujeto
...
class ResumenFacturaType(GeneratedsSuper):
    ...
    def get_TotalServNoSujeto(self):
        return self.TotalServNoSujeto

    def set_TotalServNoSujeto(self, TotalServNoSujeto):
        self.TotalServNoSujeto = TotalServNoSujeto
    ...
    def get_TotalMercNoSujeta(self):
        return self.TotalMercNoSujeta

    def set_TotalMercNoSujeta(self, TotalMercNoSujeta):
        self.TotalMercNoSujeta = TotalMercNoSujeta
    ...
    def get_TotalNoSujeto(self):
        return self.TotalNoSujeto

    def set_TotalNoSujeto(self, TotalNoSujeto):
        self.TotalNoSujeto = TotalNoSujeto
